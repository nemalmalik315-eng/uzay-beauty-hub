  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link
          href="/admin/bookings"
          className="bg-gold/10 border border-gold/20 rounded-lg p-6 text-center hover:bg-gold/20 transition-colors"
        >
        ...
        <Link
          href="/admin/billing"
          className="bg-green-50 border border-green-100 rounded-lg p-6 text-center hover:bg-green-100 transition-colors"
        >
        ...
        <Link
          href="/admin/stock"
          className="bg-blue-50 border border-blue-100 rounded-lg p-6 text-center hover:bg-blue-100 transition-colors"
        >
