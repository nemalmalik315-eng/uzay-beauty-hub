          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="min-w-0">
              <p className="font-semibold text-red-700 text-sm sm:text-base">
                {lowStockCount} item(s) running low<span className="hidden sm:inline"> on stock</span>!
              </p>
              <p className="text-xs sm:text-sm text-red-600">
                <span className="sm:hidden">At or below min threshold.</span>
                <span className="hidden sm:inline">These items are at or below their minimum threshold.</span>
              </p>
            </div>
          </div>
          <button
