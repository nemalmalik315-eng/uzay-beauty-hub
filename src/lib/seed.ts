...
async function seed() {
  ...
  if (Number(serviceRows[0].count) === 0) {
    const services: [string, string, number, number, string][] = [
      ...
      ["Engagement", "Assistant Bridal", 15000, 90, "Assistant bridal engagement makeup"],
      ["Nikkah", "Assistant Bridal", 15000, 90, "Assistant bridal nikkah makeup"],
      ["Mehndi", "Assistant Bridal", 15000, 90, "Assistant bridal mehndi makeup"],
      ["Main Day Bride", "Assistant Bridal", 25000, 180, "Assistant bridal main day — services not included"],
      ["Reception Bride", "Assistant Bridal", 25000, 120, "Assistant bridal reception makeup"],
      ["Engagement", "Signature Bridal", 20000, 90, "Signature bridal engagement makeup"],
      ["Nikkah", "Signature Bridal", 20000, 90, "Signature bridal nikkah makeup"],
      ["Mehndi", "Signature Bridal", 20000, 90, "Signature bridal mehndi makeup"],
      ["Main Day Bride (Without Services)", "Signature Bridal", 35000, 180, "Signature main day bride — services not included"],
      ["Main Day Bride — Package 1", "Signature Bridal", 40000, 300, "Whitening facial, whitening mani pedi, half arm & half legs wax, eyebrow & upper lips threading"],
      ["Main Day Bride — Premium Package", "Signature Bridal", 50000, 360, "Hydra facial, premium mani pedi, full body wax, eyebrow & upper lips threading, hair protein wash, hair trimming"],
